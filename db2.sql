...
#
# Host: tonyynot.nl (MySQL 5.5.38-0+wheezy1)
# Database: sniffer
# Generation Time: 2014-10-15 10:29:41 +0000
# ************************************************************
...
# Dump of table packetsudp
# ------------------------------------------------------------

DROP TABLE IF EXISTS `packetsudp`;

CREATE TABLE `packetsudp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `src_port` int(11) DEFAULT NULL,
  `dest_port` int(11) DEFAULT NULL,
